...
using GelladosGourmet.Models.Enums;

namespace GelladosGourmet.Data
{
    public class SeedingService
    {
        private GelladosGourmetContext _context;
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller(1, "Fernando Silva Noleto", "fernandonoleto17@gmail.com", new DateTime(1995, 06, 09), 1000.0, d1);
            Seller s2 = new Seller(2, "Maria", "maria@gmail.com", new DateTime(1984, 07, 09), 1500.0, d2);
            Seller s3 = new Seller(3, "Alex", "alex@gmail.com", new DateTime(1994, 06, 09), 7000.0, d1);
            Seller s4 = new Seller(4, "Mathar", "mathar@gmail.com", new DateTime(1965, 06, 09), 100000.0, d4);
            Seller s5 = new Seller(5, "Donald", "donald@gmail.com", new DateTime(1975, 06, 09), 5000.0, d3);
            Seller s6 = new Seller(6, "Alex", "alex@gmail.com", new DateTime(1985, 01, 12), 3000.0, d2);
